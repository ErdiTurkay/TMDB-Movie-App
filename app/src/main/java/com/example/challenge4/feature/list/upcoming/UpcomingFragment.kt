...
@AndroidEntryPoint
class UpcomingFragment : Fragment(), MovieClickListener {
    ...
    private fun setToolBar() {
        ...
        mainActivity.toolBar.run {
            ...
            title = resources.getString(R.string.upcoming_movies)
        }
    }
    ...
    private fun setRV() {
        binding.movieRV.run {
            ...
            movieAdapter = MovieAdapter(listener = this@UpcomingFragment, showNumber = false, isLarge = true)
    ...
    override fun movieOnClick(movie: Movie) {
        ...
        val destination = UpcomingFragmentDirections.actionUpcomingFragmentToMovieDetailFragment(movie)

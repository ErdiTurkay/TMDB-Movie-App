...
class TopRatedFragment : Fragment(), MovieClickListener {
    ...
    private fun setToolBar() {
        ...
        mainActivity.toolBar.run {
            ...
            title = resources.getString(R.string.top_rated_movies)
        }
    }
    ...
    private fun setRV() {
        binding.movieRV.run {
            ...
            movieAdapter = MovieAdapter(listener = this@TopRatedFragment, showNumber = true, isLarge = true)
    ...
    override fun movieOnClick(movie: Movie) {
        ...
        val destination = TopRatedFragmentDirections.actionTopRatedFragmentToMovieDetailFragment(movie)
